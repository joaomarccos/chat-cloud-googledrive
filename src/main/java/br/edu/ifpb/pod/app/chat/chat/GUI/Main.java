...
public class Main extends javax.swing.JFrame implements ListenerChangeFile {
    ...
    public Main(User user, DriveController driveController) throws IOException {
        this.user = user;        
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        try {                        
            this.loginController.logout(user);
        } catch (IOException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_formWindowClosing

    private void inciarControladores() throws IOException {        
    ...
    private void iniciarControladorMensagem() throws NumberFormatException {
        try {
            messageController = new MessageController(driveController);
    ...
    private void iniciarControladorLogin(){
        try {
            this.loginController = new LoginController(driveController);
